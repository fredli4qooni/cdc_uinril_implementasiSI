...
@section('content')
    {{-- Hero Section --}}
    @include('public.partials.hero_section')    
                        ...
                        <div
                            ...
                            <div class="p-6">
                                ...
                                <a href="{{ route('mahasiswa.vacancies.show', $vacancy->id) }}"
                                    class="block w-full bg-gradient-to-r from-green-500 to-teal-600 text-white text-center py-3 rounded-xl font-semibold hover:from-blue-600 hover:to-indigo-700 transition-all duration-300 hover:shadow-lg transform hover:scale-105">
                                    Detail & Daftar
                                </a>
                            </div>
                        </div>
